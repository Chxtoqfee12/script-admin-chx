...
-- Fly
------------------------------------------------------
local flyGuiToggle = Tab:CreateButton({
    Name = "Fly GUI",
    Callback = function()
        -- สลับการมองเห็น Frame Fly
        if not main then
            -- สร้าง GUI ครั้งแรก
            ...
            Frame.Parent = main
            Frame.Visible = true -- เปิด GUI ตอนสร้าง
        else
            -- ถ้ามีแล้วก็สลับการมองเห็น
...
game:GetService("StarterGui"):SetCore("SendNotification", { 
    Title = "Chx function Fly";
    Text = "By Chx discord https://discord.gg/zHMEUZrHZ6";
